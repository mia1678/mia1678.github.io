...
#EDIT THE FOLLOWING:
$toAddress = "meng.li@seattlecentral.edu";  //place your/your client's email address here
$toName = "倫宏實業股份有限公司"; //place your client's name here
$website = "倫宏實業股份有限公司網站";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>
		<label>
			姓名:<br /><input type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
	</div>
	<div>	
		<label>
	...
	<div>	
		<label>
			留言:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Your comments are important to us!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
